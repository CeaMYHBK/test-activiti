package com.ceam.common.redis.aspect;
...
public class RedisAspect
{
     ...
     */
    @Pointcut("@annotation(com.ceam.common.redis.annotation.RedisCache)")
    public void redisCachePoint()
    {
    }

    @Pointcut("@annotation(com.ceam.common.redis.annotation.RedisEvict)")
